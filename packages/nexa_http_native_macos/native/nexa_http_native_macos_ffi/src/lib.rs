...
pub extern "C" fn nexa_http_request_body_alloc(body_len: usize) -> *mut u8 {
    NexaHttpRuntime::<ManagedProxyState<MacosProxySource>>::request_body_alloc(body_len)
}

#[unsafe(no_mangle)]
pub extern "C" fn nexa_http_request_body_free(body_ptr: *mut u8, body_len: usize) {
    NexaHttpRuntime::<ManagedProxyState<MacosProxySource>>::request_body_free(body_ptr, body_len);
}
