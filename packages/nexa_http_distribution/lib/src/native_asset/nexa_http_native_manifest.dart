...
final class NexaHttpNativeAssetManifest {
  ...
  static Future<NexaHttpNativeAssetManifest> load(Uri uri) async {
    ...
    return NexaHttpNativeAssetManifest(
      ...
      entries: entriesJson
          .map(
            (entry) => NexaHttpNativeAssetManifestEntry.fromJson(
  ...
  NexaHttpNativeAssetManifestEntry select({
    ...
    if (expectedReleaseVersion != null &&
        expectedReleaseVersion.isNotEmpty &&
        this.packageVersion.isNotEmpty &&
        this.packageVersion != expectedReleaseVersion) {
      throw StateError(
        'Native asset manifest version mismatch. Expected $expectedReleaseVersion, got ${this.packageVersion}.',
      );
    }
...
final class NexaHttpNativeAssetManifestEntry {
  ...
  static NexaHttpNativeAssetManifestEntry fromJson(Map<String, dynamic> json) {
