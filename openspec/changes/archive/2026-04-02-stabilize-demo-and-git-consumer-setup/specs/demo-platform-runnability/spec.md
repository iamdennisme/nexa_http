...
The workspace SHALL treat `app/demo` as the single official development demo for supported platform debugging and Flutter-to-Rust integration validation.
