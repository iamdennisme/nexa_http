...
- [ ] 修改构建产物名称、crate type 或 Android target triple 时同步 canonical target matrix、Dart build hook、typed build script 和 workspace verification；Gradle 不拥有 native artifact build/copy authority。
