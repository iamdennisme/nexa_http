...
- [ ] 2.3 Ensure the workflow stops retrying only when required tag-triggered workflows succeed or the maintainer explicitly stops the run.
...
- [ ] 3.3 Run the minimum governed external-consumer verification step for that temporary demo and delete the demo after verification completes.
...
- [ ] 4.2 Execute the governed release-tag validation loop end to end, including workflow observation, retry if needed, and external consumer proof.
