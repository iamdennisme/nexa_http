...
This project now also includes `.trellis/spec/guides/flutter-sdk-authoring-contract.md`
as the source of truth for Flutter SDK host integration boundaries, native
artifact lifecycle ownership, failure reporting, and release-gating clean-host
verification.

It also includes `.trellis/spec/guides/documentation-language-policy.md`.
All rule documents under `.trellis/spec/` should be written in Chinese, while
code identifiers, commands, package names, and external tool terms may keep
