# nexa_http_native_macos_ffi Rust 规范

> macOS FFI crate 位于 `packages/nexa_http_native_macos/native/nexa_http_native_macos_ffi`，负责产出 macOS 动态库并把共享 core runtime 绑定到 macOS proxy source。
